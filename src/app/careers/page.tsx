        ...
        <div className="relative z-10 max-w-section mx-auto px-4 sm:px-6 lg:px-8 py-32">
          <div className="max-w-4xl">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-6">
              <span className="text-primary-400 text-sm font-medium">Join Our Team</span>
            </div>
      ...
      <section className="py-24 bg-dark-900">
        <div className="max-w-section mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/about" className="btn-secondary border-white/20 text-white hover:bg-white/10">
              Learn More About Us
            </Link>
          </div>
        </div>
